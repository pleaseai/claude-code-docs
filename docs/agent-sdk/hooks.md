...
<Tip>
  **Discovering tool names:** See [Tool Input Types](./typescript.md#tool-input-types) for the full list of built-in tool names, or add a hook without a matcher to log all tool calls your session makes.
