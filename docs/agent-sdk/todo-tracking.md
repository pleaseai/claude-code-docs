...
Before running these examples, install the Claude Agent SDK by following the [quickstart](./quickstart.md).
...
See [Handle the result](./agent-loop.md#handle-the-result) for the result subtypes.
